...
class LendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lender" do
    assert_difference('Lender.count') do
      post lenders_url, params: { lender: { email: @lender.email, first_name: @lender.first_name, last_name: @lender.last_name, phone: @lender.phone, state: @lender.state, street: @lender.street, zip: @lender.zip } }
    end
  ...
  test "should update lender" do
    patch lender_url(@lender), params: { lender: { email: @lender.email, first_name: @lender.first_name, last_name: @lender.last_name, phone: @lender.phone, state: @lender.state, street: @lender.street, zip: @lender.zip } }
